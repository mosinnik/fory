...
```bash
flatc -o src/main/java -j src/main/java/org/apache/fory/benchmark/state/bench.fbs
flatc -o src/main/java -j src/main/flatbuffers/xlang_bench.fbs
protoc -I=../proto --java_out=src/main/java ../proto/bench.proto
```
